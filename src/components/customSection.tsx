...
const CustomSection = ({title,Icon,children,customStyle} : SectionProps) => {
  return (
    <>
      <section onClick={(e)=> e.stopPropagation()} className={`${customStyle } bg-gray-50 p-4  lg:p-5 shadow-md rounded-lg ring-2 ring-gray-300 ring-offset-4 ring-offset-gray-50 ring-inset`}>
